// ============================================================
//  grammatica/indicatif_present_soort1b.js
//  Grammaticaregel: werkwoorden op -cer
// ============================================================
...
export function grammaticaHTML(werkwoord) {
  ...
  return `
    <div class="gr-titel">GRAMMATICAREGEL — Verbes en -CER</div>
    <div class="gr-inhoud">
      ...
      <p>Bij werkwoorden op <strong>-cer</strong> verandert de <strong>c</strong> in
        <strong>ç</strong> voor de uitgang <strong>-ons</strong>.<br>
        Dit is om de zachte uitspraak van de <strong>c</strong> te bewaren.
      </p>
      <p class="gr-voorbeeld">
        ${stam.slice(0,-1)}<strong>c</strong>er → nous ${stam.slice(0,-1)}<strong>ç</strong>ons
      </p>
      ...
      <table class="gr-tabel">
        ...
        <tr class="gr-nadruk">
          <td>nous</td>
          <td class="gr-uitkomst">${v.nous} ← let op de <strong>ç</strong>!</td>
        </tr>
